...
def get_simple_unet_model(input_shape=(256, 192, 3), output_channels: int=3):

    # Simple U-net architecture

    inputs = tf.keras.Input(shape=input_shape)

    encoder1 = conv(inputs, 32) # 256 x 192 x 32
...
def get_res_unet_model(input_shape=(256, 192, 3), output_channels: int=3):
